...
async def send_stars_invoice(update: Update, context: ContextTypes.DEFAULT_TYPE, product_id: int):
    ...
    products = {
        ...
        21: {'title': '⭐ Приоритетная поддержка', 'description': 'VIP помощь навсегда', 'stars': 1000, 'coins': 5000000},
        22: {'title': '🚀 Автотап премиум', 'description': 'Безлимитный автоклик', 'stars': 1600, 'coins': 8000000},
        23: {'title': '👑 Золотой статус', 'description': 'Эксклюзивный бейдж', 'stars': 2400, 'coins': 12000000},
        24: {'title': '⚡ Турбо ускорение', 'description': 'x10 быстрее доход', 'stars': 3200, 'coins': 16000000},
        25: {'title': '💎 Королевская привилегия', 'description': 'Доступ к VIP секциям', 'stars': 4000, 'coins': 20000000},
        26: {'title': '🔓 Безлимитный лимит', 'description': 'Снять все ограничения', 'stars': 5000, 'coins': 25000000},
        27: {'title': '🏆 Топ чарт гарантия', 'description': 'Замок в топ-100', 'stars': 6000, 'coins': 30000000},
        28: {'title': '🌟 Легендарный профиль', 'description': 'Уникальный бейдж профиля', 'stars': 7000, 'coins': 35000000},
        29: {'title': '💎 Алмазный VIP пакет', 'description': 'Всё премиум сразу', 'stars': 8000, 'coins': 40000000},
        30: {'title': '👑 Императорский доступ', 'description': 'Все функции навсегда', 'stars': 9000, 'coins': 45000000},
