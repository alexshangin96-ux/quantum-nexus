...
Выберите действие:"""
    ...
    keyboard = [
        [
            InlineKeyboardButton("🎮 Открыть игру", web_app=WebAppInfo(url="https://quantum-nexus.ru/web_app.html?v=5.0&FORCE_RELOAD=" + str(int(__import__('time').time())) + "&nocache=1"))
        ]
    ]
